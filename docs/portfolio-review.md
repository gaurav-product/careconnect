...
| **Technical understanding** | 8/10 | Working full-stack MVP with role-scoped authorisation, an append-only audit trail, correct IST handling and 95 automated checks. Architecture choices are justified by constraints and their costs are named. |
