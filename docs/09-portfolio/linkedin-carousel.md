...
**Source:** `docs/01-problem/problem-discovery.md`
...
short.
**Source:** `docs/02-research/evidence-index.md` (S14, S22), `docs/02-research/competitive-analysis.md`
...
**Source:** `docs/05-decisions/decision-log.md` (D-01, D-02)
...
**Source:** `docs/03-strategy/product-strategy.md`
...
circled.
**Source:** `docs/04-product/design-decisions.md` (D-03, D-04)
...
was not hungry" → "done".
**Source:** `docs/05-decisions/decision-log.md` (D-17), `docs/08-engineering/testing.md`
...
**Source:** `docs/07-validation/validation-plan.md`, `docs/06-metrics/metrics.md` (D-18)
...
**Source:** `docs/09-portfolio/learnings.md`
...
| Slide | Chart | Data |
| --- | --- | --- |
| 3 | Time-to-find by channel | `docs/01-problem/problem-discovery.md` supply table |
| 4 | Complaint themes | `docs/02-research/evidence-index.md` (S13, S16, S9) |
| 10 | Validated vs unvalidated | `docs/07-validation/validation-plan.md` Part C |
