...
>
> Then I built it: React + Express, 142 automated checks, two QA passes.
>
...
- If someone asks "did you talk to users?", the answer is: no, secondary research only, and
  the interview guides are in `docs/07-validation/validation-plan.md`. Say it before they ask — it
