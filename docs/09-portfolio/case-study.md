...
`docs/02-research/evidence-index.md`, and provider marketing is never quoted as a statistic. Where a
...
Twenty-five decisions with alternatives and evidence: `docs/05-decisions/decision-log.md`.
...
**142 automated checks** — 70 unit and integration tests, 72 end-to-end journeys across
...
| Claim | Evidence |
| --- | --- |
| The core flows work end to end on phone, tablet and desktop | 142 automated checks |
...
*Sources are graded A–D and indexed in `docs/02-research/evidence-index.md`, with a claim register
