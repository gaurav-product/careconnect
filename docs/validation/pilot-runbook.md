...
- [ ] The consent script (see [participant materials](participant-materials.md)) is spoken
...
| Observations during the two visits | [Daily log](participant-materials.md) | 2 × 30 min |
...
Fill the [evidence table](evidence-table.md) before drawing any conclusion. Separate **what
...
Then update the tracker in [19-validation-plan.md](19-validation-plan.md) — a row moves to
